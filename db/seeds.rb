...
flats = [
  ...
  { name: 'Connie House', address: 'Wall Rose', description: 'A small house in the southern area of the land surrounded by Wall Rose. It is occupied by a titan...', price_per_night: 14, number_of_guests: 3, picture_url: 'https://yurireviewsandmore.files.wordpress.com/2017/06/snk-11.jpg' }
]
