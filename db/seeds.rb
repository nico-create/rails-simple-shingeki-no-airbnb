...
flats = [
  ...
  { name: 'Utgard Castle', address: 'Wall Rose', description: 'Utgard Castle is an abandoned castle close to the inner side of Wall Rose. It contains large quantities of old food supplies, including liquor and cans of herring with strange writing on them.', price_per_night: 118, number_of_guests: 8, picture_url: 'https://i.quotev.com/img/q/u/20/2/11/jenjb6kj2h.jpg'  },
  { name: 'Reiss Chapel', address: 'Wall Rose', description: 'The Reiss Chapel was a church owned by the Reiss family. On the surface, it appeared to be a regular church that the Reiss family frequently prayed in.', price_per_night: 65, number_of_guests: 6, picture_url: 'https://static.wikia.nocookie.net/shingekinokyojin/images/b/b6/The_Reiss_Chapel_above_ground.png' }
]
